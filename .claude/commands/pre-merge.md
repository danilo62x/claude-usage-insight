...
- If the change implements a Discussion or resolves an Issue, link it in the entry text, e.g. `- [Feature name](https://github.com/danilo62x/claude-usage-insight/discussions/12) - description`.
...
- Bug report only: `(thanks to [@handle](https://github.com/handle) for reporting [#NN](https://github.com/danilo62x/claude-usage-insight/issues/NN))`
