# Vendored from https://github.com/phuryn/claude-usage (scanner.py), MIT License,
# Copyright (c) 2026 Pawel Huryn.  See THIRD-PARTY.md for the full notice.
#
# Local changes are marked with "# [fork]".  Keep them minimal so upstream fixes
# can be re-applied by diffing against the original file.
"""
