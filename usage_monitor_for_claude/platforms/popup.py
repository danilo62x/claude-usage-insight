...
if sys.platform == 'win32':
    from .popup_win32 import PANEL_WINDOW_KWARGS, WINDOW_KWARGS, PopupHost, apply_panel_window_style, popup_url, set_window_opacity
else:
    from .popup_linux import PANEL_WINDOW_KWARGS, WINDOW_KWARGS, PopupHost, apply_panel_window_style, popup_url, set_window_opacity
